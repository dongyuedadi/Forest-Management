...
# ==================== 配置参数 ====================
nc_path = r"C:\Users\hys5637428\Desktop\CanESM5ev\historical\evap_VIC_historical_2000_monthly.nc"  # NetCDF 文件路径
output_excel = r"C:\Users\hys5637428\Desktop\不同阶段经营模式\课题汇报\结果\evp结果.xlsx"  # 输出结果文件路径
...
# ==================== 定义提取函数 ====================
def extract_runoff(dataset, lon, lat, var_name='evap'):
    """
...
# 将列表拆分成单独的列
df[months] = df['evap'].apply(pd.Series)
