...
result = pd.DataFrame(columns=['Plot', '小径木株树', '中径木株树', '大径木株树'])
# 遍历每个Plot，计算大中小径木的蓄积
...
for Plot in Plots:
    ...
    for sps in Plot_data['树种'].unique():
        ...
        small_diameter_volume = Plot_data_sps[Plot_data_sps['分类'] == '小径木']['径阶株树'].sum()
        medium_diameter_volume = Plot_data_sps[Plot_data_sps['分类'] == '中径木']['径阶株树'].sum()
        large_diameter_volume = Plot_data_sps[Plot_data_sps['分类'] == '大径木']['径阶株树'].sum()
